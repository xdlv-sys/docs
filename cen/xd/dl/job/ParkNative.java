...
//	ParkedCarInfo obj = getParkedCarInfo(0,"苏A12366",15, 0, 2, "", "");
...
//	System.out.println("CarLicense = "+obj.sCarLicense+ " money = "+obj.fMoney + " intime =" +  obj.sInTime + " parkedtime=" + obj.iParkedTime + " InPic = "+obj.sInPic + " ID = "+obj.sID + " return val =" + obj.iReturn); 
//	payParkCarFee(0,"苏A12366","2016-11-18 14:45:08",.6f, "79853", "2016/11/17 10:57:16", 1);
...
//  }
	...
	aCarportObj=getCarportInfo("苏A12344");
	...
	payCarportRent("苏A12344", "102", "虚拟20", aCarportNum, "2016-12-12 09:32:49", 3, 3, false);
	payCarportRent("苏A12344", "102", "虚拟20", aCarportNum, "2016-12-12 09:32:50", 3, 4.0f, false);
	payCarportRent("苏A12344", "102", "虚拟20", aCarportNum, "2016-12-12 09:32:51", 3, 12, true);
	payCarportRent("苏A12344", "102", "虚拟20", aCarportNum, "2016-12-12 09:32:52", 3, 3, true);
